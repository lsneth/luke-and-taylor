    ...
    return (
        <div className='eucalyptus-bg'>
            <div id='registry-content'>
                <img id='registry-img' src={portrait}/>
                <p className='text'>
                    ...
                    at our wedding is the greatest gift of all, and we cannot wait to celebrate this
                    joyous occasion with you. If you would like to contribute to our home, we have
